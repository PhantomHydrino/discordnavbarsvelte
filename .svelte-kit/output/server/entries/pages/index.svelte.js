import { c as create_ssr_component, o as onDestroy, a as spread, b as escape_object, d as createEventDispatcher, v as validate_component, e as escape } from "../../chunks/index-b192fdc5.js";
...
const SideBarIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.text === void 0 && $$bindings.text && text !== void 0)
    $$bindings.text(text);
  return `<div class="${"sidebar-icon group"}">${validate_component(Icon, "Icon").$$render($$result, { icon, style: "font-size: 20px;" }, {}, {})}
    <span class="${"sidebar-toolkit group-hover:scale-100"}">${escape(text)}</span></div>`;
});
const SideBar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"fixed bottom-0 left-0 w-16 flex flex-col bg-gray-900 drop-shadow-3xl justify-center hover:h-[80%]"}">${validate_component(SideBarIcon, "SideBarIcon").$$render($$result, {
    icon: "ant-design:home-filled",
    text: "tooltips"
  }, {}, {})}
    ${validate_component(SideBarIcon, "SideBarIcon").$$render($$result, { icon: "el:fire", text: "tooltips" }, {}, {})}
    ${validate_component(SideBarIcon, "SideBarIcon").$$render($$result, { icon: "fa-solid:poo", text: "tooltips" }, {}, {})}
    ${validate_component(SideBarIcon, "SideBarIcon").$$render($$result, {
...
const MainScreen = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<body class="${"bg-gray-700"}"></body>`;
});
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(MainScreen, "MainScreen").$$render($$result, {}, {}, {})}
